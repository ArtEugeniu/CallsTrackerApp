...
export function analyzeUserMessage(message) {
  ...
  const isUpdateRequest = userMessage.includes('update') || userMessage.includes('schimba') || userMessage.includes('modifica') || userMessage.includes('schimbă') || userMessage.includes('modifică');
  const isCreateRequest = userMessage.includes('creaza') || userMessage.includes('adauga') || userMessage.includes('creează') || userMessage.includes('adaugă') || userMessage.includes('nou') || userMessage.includes('create');
  const isDeleteRequest = userMessage.includes('sterge') || userMessage.includes('delete') || userMessage.includes('șterge') || userMessage.includes('elimina') || userMessage.includes('elimină');
